...
<section class="update-profile">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <img src="uploaded_img/<?= $fetch_profile['image']; ?>" alt="Foto de perfil">
      <div class="flex">
         <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Ingresar contraseña anterior" class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_pag.php" class="option-btn">Volver atras</a>
      </div>
   </form>
