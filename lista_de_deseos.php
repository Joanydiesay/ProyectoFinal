...
if(isset($_GET['delete'])){
   ...
   header('location:lista_de_deseos.php');
...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      <a href="lista_de_deseos.php?delete=<?= $fetch_wishlist['id']; ?>" class="fas fa-times" onclick="return confirm('¿Eliminar esto de la lista de deseos?');"></a>
      <a href="vista_pag.php?pid=<?= $fetch_wishlist['pid']; ?>" class="fas fa-eye"></a>
   ...
   <div class="wishlist-total">
      ...
      <a href="lista_de_deseos.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>">eliminar todo</a>
   </div>
